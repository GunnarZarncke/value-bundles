...
The next follow-up tested delayed and annealed transfer-variance pressure. See `docs/barter_mve_delayed_quantity_pressure.md`. Delaying the pressure improved over immediate transfer-variance pressure, but still did not beat receiver-heavy outcome consistency.
