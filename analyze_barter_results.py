...
def format_markdown(results: Sequence[EvaluationResult], *, source: Path, train_episodes: int) -> str:
...
def main() -> None:
    ...
    markdown = format_markdown(results, source=args.csv, train_episodes=args.episodes)
